...
<html lang="en">
  ...
  <body>
<link rel="stylesheet" href="/showdoc/Public/css/index.css" />
		...
		<div id="myCarousel" class="carousel slide">
		   ...
		   <div class="carousel-inner">
		      <div class="item active">
		         <img src="/showdoc/Public/img/pic1.jpg" alt="First slide">
		      </div>
		      <div class="item">
		         <img src="/showdoc/Public/img/pic2.jpg" alt="Second slide">
		      </div>
 		      <div class="item">
		         <img src="/showdoc/Public/img/pic3.jpg" alt="Third slide">
		      </div>
		   </div>
		   <!-- 轮播（Carousel）导航 -->
